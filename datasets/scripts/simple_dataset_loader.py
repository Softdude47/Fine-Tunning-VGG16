...
class Simple_Dataset_Loader:
    ...
    def load_image(self, image_path, target_size=None, grayscale=False, interpolation="nearest"):
        loaded_img = load_img(image_path, grayscale=grayscale, target_size=target_size, interpolation=interpolation)
        return loaded_img